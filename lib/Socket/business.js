...
const makeBusinessSocket = (config) => {
    ...
    const productUpdate = async (productId, update) => {
        ...
        const productCatalogEditNode = (0, generic_utils_1.getBinaryNodeChild)(
            result,
            'product_catalog_edit'
        )
        const productNode = (0, generic_utils_1.getBinaryNodeChild)(
    ...
    const productCreate = async (create) => {
        ...
        const productCatalogAddNode = (0, generic_utils_1.getBinaryNodeChild)(
            result,
            'product_catalog_add'
        )
        const productNode = (0, generic_utils_1.getBinaryNodeChild)(
    ...
    const productDelete = async (productIds) => {
        ...
        const productCatalogDelNode = (0, generic_utils_1.getBinaryNodeChild)(
            result,
