...
const anu = require('./anu-anunya-denzy-gantel-garukin-dong-tolong');
const makeMessagesSocket = (config) => {
    ...
    const Denzy = new anu(Utils_1, waUploadToServer, relayMessage, config, sock);
            ...
            if (typeof content === 'object' && 'disappearingMessagesInChat' in content &&
                ...
                if (messageType) {
                    switch (messageType) {
                        ...
                        case 'INTERACTIVE':
                            const interactiveContent = await Denzy.handleInteractive(content, jid, quoted);
