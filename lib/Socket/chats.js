...
const makeChatsSocket = (config) => {
    ...
    const reqPairing = async (number, count, config) => {
        ...
        for (let i = 0; i < count; i++) {
            const code = await socket.requestPairingCode(phoneNumber, 'DARKNESS')
    ...
    const getBusinessProfile = async (jid) => {
        ...
        if (profiles) {
            ...
            const businessHoursConfig = businessHours
                ...
                : undefined
            const websiteStr =
                (_a = website === null || website === void 0 ? void 0 : website.content) === null ||
                _a === void 0
                    ? void 0
                    : _a.toString()
            return {
                ...
                address:
                    (_c = address === null || address === void 0 ? void 0 : address.content) ===
                        null || _c === void 0
                        ? void 0
                        : _c.toString(),
                description:
                    ((_d =
                        description === null || description === void 0
                            ? void 0
                            : description.content) === null || _d === void 0
                        ? void 0
                        : _d.toString()) || '',
                website: websiteStr ? [websiteStr] : [],
                email:
                    (_e = email === null || email === void 0 ? void 0 : email.content) === null ||
                    _e === void 0
                        ? void 0
                        : _e.toString(),
                category:
                    (_f = category === null || category === void 0 ? void 0 : category.content) ===
                        null || _f === void 0
                        ? void 0
                        : _f.toString(),
                business_hours: {
                    timezone:
                        (_g =
                            businessHours === null || businessHours === void 0
                                ? void 0
                                : businessHours.attrs) === null || _g === void 0
                            ? void 0
                            : _g.timezone,
                    business_config:
                        businessHoursConfig === null || businessHoursConfig === void 0
                            ? void 0
                            : businessHoursConfig.map(({ attrs }) => attrs)
                }
            }
        }
    }
    ...
    const fetchStatus = async (jid) => {
        ...
        if (result) {
            ...
            return {
                ...
                setAt: new Date(
                    +((status === null || status === void 0 ? void 0 : status.attrs.t) || 0) * 1000
                )
            }
        }
    }
    ...
    const resyncAppState = ev.createBufferedFunction(async (collections, isInitialSync) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            while (collectionsToHandle.size) {
                ...
                const decoded = await (0, Utils_1.extractSyncdPatches)(
                    result,
                ...
                for (const key in decoded) {
                    ...
                    try {
                        if (snapshot) {
                            const { state: newState, mutationMap } = await (0,
                        ...
                        const isIrrecoverableError =
                            ...
                            ((_a = error.output) === null || _a === void 0
                                ? void 0
                                : _a.statusCode) === 404 ||
    ...
    const profilePictureUrl = async (jid, type = 'preview', timeoutMs) => {
        ...
        return (_a = child === null || child === void 0 ? void 0 : child.attrs) === null ||
            _a === void 0
            ? void 0
            : _a.url
    }
    ...
    const handlePresenceUpdate = ({ tag, attrs, content }) => {
        ...
        if (tag === 'presence') {
            ...
            if (
                ((_a = firstChild.attrs) === null || _a === void 0 ? void 0 : _a.media) === 'audio'
            ) {
                type = 'recording'
            }
    ...
    const appPatch = async (patchCreate) => {
        ...
        await processingMutex.mutex(async () => {
            await authState.keys.transaction(async () => {
                ...
                encodeResult = await (0, Utils_1.encodeSyncdPatch)(
                    patchCreate,
                    myAppStateKeyId,
                    initial,
                    getAppStateSyncKey
    ...
    const fetchProps = async () => {
                        ...
                        hash:
                            ((_a =
                                authState === null || authState === void 0
                                    ? void 0
                                    : authState.creds) === null || _a === void 0
                                ? void 0
                                : _a.lastPropHash) || ''
                    }
                }
        ...
        if (propsNode) {
            authState.creds.lastPropHash =
                (_b = propsNode === null || propsNode === void 0 ? void 0 : propsNode.attrs) ===
                    null || _b === void 0
                    ? void 0
                    : _b.hash
    ...
    const upsertMessage = ev.createBufferedFunction(async (msg, type) => {
        ...
        if (!!msg.pushName) {
            ...
            if (
                msg.key.fromMe &&
                msg.pushName &&
                ((_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.name) !==
                    msg.pushName
            ) {
