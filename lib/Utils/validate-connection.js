...
const getUserAgent = (config) => {
    return {
        ...
        // WA started rejecting Platform.WEB on fresh pairing (405 frc/rva) in
        // Feb 2026 — MACOS still gets through registration.
...
const configureSuccessfulPairing = (
    ...
    const { details, hmac, accountType } = WAProto_1.proto.ADVSignedDeviceIdentityHMAC.decode(
    ...
    const accountSignaturePrefix =
        deviceIdentity.deviceType === WAProto_1.proto.ADVEncryptionType.HOSTED
