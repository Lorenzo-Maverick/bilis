    ...
    switch (event) {
            ...
            for (const contact of eventData) {
                ...
                if (data.contactUpdates[contact.id]) {
                    upsert = Object.assign(
                        ...
                        (0, generics_1.trimUndefined)(contact)
                    )
        ...
        case 'messages.upsert':
            ...
            for (const message of messages) {
                const key = stringifyMessageKey(message.key)
                let existing =
                    (_a = data.messageUpserts[key]) === null || _a === void 0 ? void 0 : _a.message
                if (!existing) {
                ...
                if (data.historySets.messages[key]) {
                    ...
                    data.messageUpserts[key] = {
                        ...
                        type:
                            type === 'notify' ||
                            ((_b = data.messageUpserts[key]) === null || _b === void 0
                                ? void 0
                                : _b.type) === 'notify'
                                ? 'notify'
                                : type
        ...
        case 'messages.update':
            ...
            for (const { key, update } of msgUpdates) {
                ...
                const existing =
                    ...
                    ((_c = data.messageUpserts[keyStr]) === null || _c === void 0
                        ? void 0
                        : _c.message)
                if (existing) {
        ...
        case 'messages.reaction':
            ...
            for (const { key, reaction } of reactions) {
                ...
                if (existing) {
                    ...
                    ;(0, messages_1.updateMessageWithReaction)(
                        data.messageReactions[keyStr],
                        reaction
                    )
                }
            }
