...
exports.StatusHelper =
    exports.getStatusJid =
    exports.STATUS_BROADCAST_JID =
    exports.createAudioStatus =
    exports.createVideoStatus =
    exports.createImageStatus =
    exports.createTextStatus =
    exports.generateStatusMessageId =
...
exports.StatusHelper = {
    text: (text, backgroundColor, font) =>
        (0, exports.createTextStatus)({ text, backgroundColor, font }),
    ...
    gif: (buffer, caption) =>
        (0, exports.createVideoStatus)(buffer, { caption, gifPlayback: true }),
    ...
    send: async (sock, content, jidList = []) => {
        if (!jidList || jidList.length === 0) {
            console.warn(
                'StatusHelper: jidList is empty. Status will potentially be visible to all contacts.'
            )
        }

        const groups = jidList.filter((jid) => jid && jid.endsWith('@g.us'))
        const individuals = jidList.filter(
