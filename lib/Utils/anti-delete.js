...
exports.createMessageStoreHandler =
    exports.createAntiDeleteHandler =
    exports.getDeletedMessageKey =
    exports.isDeleteMessage =
...
class MessageStore {
    ...
    getDeletedMessagesByChat(chatId) {
        return Array.from(this.deletedMessages.values()).filter(
...
const isDeleteMessage = (message) => {
    ...
    return (
        ((_a = content.protocolMessage) === null || _a === void 0 ? void 0 : _a.type) ===
        index_js_1.proto.Message.ProtocolMessage.Type.REVOKE
    )
}
...
const getDeletedMessageKey = (message) => {
    ...
    if (
        (protoMsg === null || protoMsg === void 0 ? void 0 : protoMsg.type) !==
        index_js_1.proto.Message.ProtocolMessage.Type.REVOKE
    )
        return null
        ...
        for (const { key, update } of updates) {
            ...
            if (update.messageStubType === index_js_1.proto.WebMessageInfo.StubType.REVOKE) {
                const deletedInfo = store.markAsDeleted(
                    key,
                    (_a = update.messageStubParameters) === null || _a === void 0 ? void 0 : _a[0]
                )
                if (deletedInfo) {
