    ...
    return (
        (!!normalizedContent ||
            ...
            (REAL_MSG_REQ_ME_STUB_TYPES.has(message.messageStubType) &&
                ((_a = message.messageStubParameters) === null || _a === void 0
                    ? void 0
                    : _a.some((p) => (0, WABinary_1.areJidsSameUser)(meId, p))))) &&
        hasSomeContent &&
...
const processMessage = async (
    ...
    if (
        (isRealMsg ||
            ((_b =
                (_a = content === null || content === void 0 ? void 0 : content.reactionMessage) ===
                    null || _a === void 0
                    ? void 0
    ...
    if (protocolMsg) {
        switch (protocolMsg.type) {
            case WAProto_1.proto.Message.ProtocolMessage.Type.HISTORY_SYNC_NOTIFICATION:
                ...
                const isLatest = !((_c = creds.processedHistoryMessages) === null || _c === void 0
                    ? void 0
                    : _c.length)
                ...
                if (process) {
                    ...
                    const data = await (0, history_1.downloadAndProcessHistorySyncNotification)(
                        histNotification,
                        options
                    )
            ...
            case WAProto_1.proto.Message.ProtocolMessage.Type
                ...
                if (response) {
                    ...
                    for (const result of peerDataOperationResult) {
                        ...
                        if (retryResponse) {
                            const webMessageInfo = WAProto_1.proto.WebMessageInfo.decode(
        ...
        const participantsIncludesMe = () =>
            participants.find((jid) => (0, WABinary_1.areJidsSameUser)(meId, jid))
        switch (message.messageStubType) {
            ...
            case Types_1.WAMessageStubType.GROUP_CHANGE_ANNOUNCE:
                const announceValue =
                    (_d = message.messageStubParameters) === null || _d === void 0 ? void 0 : _d[0]
                emitGroupUpdate({ announce: announceValue === 'true' || announceValue === 'on' })
                break
            case Types_1.WAMessageStubType.GROUP_CHANGE_RESTRICT:
                const restrictValue =
                    (_e = message.messageStubParameters) === null || _e === void 0 ? void 0 : _e[0]
                emitGroupUpdate({ restrict: restrictValue === 'true' || restrictValue === 'on' })
                break
            case Types_1.WAMessageStubType.GROUP_CHANGE_SUBJECT:
                const name =
                    (_f = message.messageStubParameters) === null || _f === void 0 ? void 0 : _f[0]
                chat.name = name
                emitGroupUpdate({ subject: name })
                break
            case Types_1.WAMessageStubType.GROUP_CHANGE_INVITE_LINK:
                const code =
                    (_g = message.messageStubParameters) === null || _g === void 0 ? void 0 : _g[0]
                emitGroupUpdate({ inviteCode: code })
                break
            case Types_1.WAMessageStubType.GROUP_MEMBER_ADD_MODE:
                const memberAddValue =
                    (_h = message.messageStubParameters) === null || _h === void 0 ? void 0 : _h[0]
                emitGroupUpdate({ memberAddMode: memberAddValue === 'all_member_add' })
                break
            case Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_MODE:
                const approvalMode =
                    (_j = message.messageStubParameters) === null || _j === void 0 ? void 0 : _j[0]
