...
exports.quickContact =
    exports.createContactCards =
    exports.createContactCard =
    exports.parseVCard =
    exports.generateVCards =
...
const generateVCard = (contact) => {
    ...
    if (contact.phones && contact.phones.length > 0) {
        for (const phone of contact.phones) {
            ...
            if (phone.label) {
                lines.push(
                    `TEL;type=${type};type=VOICE;X-ABLabel=${escapeVCard(phone.label)}:${formattedPhone}`
                )
            } else {
