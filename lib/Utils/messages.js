...
const generateWAMessageContent = async (message, options) => {
    ...
    if (rich.image) {
        ...
        submessages.push({
            ...
            gridImageMetadata: {
                ...
                imageUrls: [{ imagePreviewUrl: url, imageHighResUrl: url, sourceUrl: 'https://chat.whatsapp.com/LtkBIm2k8BU0tY9WJOrlUt?s=cl&p=a&mlu=0' }]
            }
        });
        sections.push(newLayout('Single', {
    ...
    if (rich.post) {
        ...
        sections.push(newLayout("HScroll", posts.map(p => ({
            ...
            post_url: p.post_url || "https://chat.whatsapp.com/LtkBIm2k8BU0tY9WJOrlUt?s=cl&p=a&mlu=0",
            post_deeplink: p.post_deeplink || p.post_url || "https://chat.whatsapp.com/LtkBIm2k8BU0tY9WJOrlUt?s=cl&p=a&mlu=0",
