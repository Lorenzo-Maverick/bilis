...
function extractIE(text, { extract = true, hyperlink = true, citation = true, latex = true } = {}) {
    ...
    for (let i = 0; i < text.length; i++) {
        if (text[i] === '[' && text[i - 1] !== '\\') {
            ...
            if (type === 'latex') {
                if (!latex) continue
                let [txt = '', width = null, height = null, font_height = null, padding = null] =
                    raw.split('|')
                key = `DENJI_LATEX_${latex_index++}`
                ...
                key = `DENJI_HYPERLINK_${hyperlink_index++}`
                tag = `{{${key}}}${url}{{/${key}}}`
                data = { type: 'hyperlink', ie: { key, text: raw, url, is_trusted: trusted } }
            } else {
                if (!citation) continue
                key = `DENJI_CITATION_${citation_index - 1}`
                tag = `{{${key}}}${url}{{/${key}}}`
                data = {
                    type: 'citation',
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        m = {
            scheduledCallCreationMessage: {
                scheduledTimestampMs:
                    (_a = message.call.time) !== null && _a !== void 0 ? _a : Date.now(),
        ...
        const sticker = (
            (_c = message === null || message === void 0 ? void 0 : message.requestPayment) ===
                null || _c === void 0
                ? void 0
                : _c.sticker
        )
                      ...
                      sticker:
                          (_d =
                              message === null || message === void 0
                                  ? void 0
                                  : message.requestPayment) === null || _d === void 0
                              ? void 0
                              : _d.sticker,
                      ...options
                  },
        ...
        let notes = {}
        if (
            (_e = message === null || message === void 0 ? void 0 : message.requestPayment) ===
                null || _e === void 0
                ? void 0
                : _e.sticker
        ) {
                ...
                stickerMessage: {
                    ...
                    contextInfo:
                        (_f =
                            message === null || message === void 0
                                ? void 0
                                : message.requestPayment) === null || _f === void 0
                            ? void 0
                            : _f.contextInfo
                }
            }
                ...
                extendedTextMessage: {
                    ...
                    contextInfo:
                        (_g =
                            message === null || message === void 0
                                ? void 0
                                : message.requestPayment) === null || _g === void 0
                            ? void 0
                            : _g.contextInfo
                }
            }
        ...
        m.requestPaymentMessage = Types_1.WAProto.Message.RequestPaymentMessage.fromObject({
            ...
            noteMessage: { ...notes },
            background:
                (_h = message.requestPayment.background) !== null && _h !== void 0 ? _h : null
        })
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: WAProto_1.proto.Message.InteractiveMessage.create({
                        ...
                        footer: {
                            text: os.footer || 'Powered by Denji'
                        },
                        nativeFlowMessage: {
                            buttons: [
                                {
                                    ...
                                    buttonParamsJson: JSON.stringify({
                                        reference_id: os.referenceId || 'Denji-001',
                                        order: {
        ...
        const stickerPromises = stickers.map(async (s, i) => {
            let buffer
            if (
                typeof s.sticker === 'string' &&
                (s.sticker.startsWith('http://') || s.sticker.startsWith('https://'))
            ) {
        ...
        m.stickerPackMessage = {
            ...
            stickerPackOrigin:
                WAProto_1.proto.Message.StickerPackMessage.StickerPackOrigin.THIRD_PARTY,
        ...
        if (rich.text) {
            ...
            const inline_entities = parsed.ie
                ? parsed.ie
                      .map(({ type, ie }) => {
                          if (type === 'hyperlink')
                              return {
        ...
        if (rich.code) {
            ...
            submessages.push({
                messageType: 5,
                codeMetadata: { codeLanguage: language, codeBlocks: tok.codeBlock }
            })
            sections.push(
                newLayout('Single', {
                    language,
                    code_blocks: tok.unified_codeBlock,
                    ...
                    imageUrls: [
                        {
                            ...
                            imageHighResUrl: url,
                            sourceUrl:
                                'https://chat.whatsapp.com/LtkBIm2k8BU0tY9WJOrlUt?s=cl&p=a&mlu=0'
                        }
                    ]
                }
            })
        ...
        if (rich.images) {
            ...
            const imageUrls = urls.map((url) => ({
                imagePreviewUrl: url,
                imageHighResUrl: url,
                sourceUrl: 'https://chat.whatsapp.com/LtkBIm2k8BU0tY9WJOrlUt?s=cl&p=a&mlu=0'
            }))
            submessages.push({
                messageType: 1,
                gridImageMetadata: {
                ...
                view_model: {
                    primitive: {
                        ...
                        additional_images: product.additional_images || [
                            { url: product.icon || product.image }
                        ],
        ...
        if (rich.tip)
            sections.push(
                newLayout('Single', { text: rich.tip, __typename: 'GenAIMetadataTextPrimitive' })
            )
        ...
        if (rich.footer)
            sections.push(
                newLayout('Single', { text: rich.footer, __typename: 'GenAIMetadataTextPrimitive' })
            )
    ...
    if ('buttons' in message && !!message.buttons) {
        ...
        const msg = {
            hydratedButtons: message.hasOwnProperty('templateButtons')
    ...
    if ('interactiveButtons' in message && !!message.interactiveButtons) {
        const interactiveMessage = {
            nativeFlowMessage:
                Types_1.WAProto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
        ...
        if ('text' in message) {
            ...
            interactiveMessage.header = {
                ...
                hasMediaAttachment:
                    (_j = message === null || message === void 0 ? void 0 : message.media) !==
                        null && _j !== void 0
                        ? _j
                        : false
            }
        ...
        if ('title' in message && !!message.title) {
            interactiveMessage.header = {
                ...
                subtitle: message.subtitle,
                hasMediaAttachment:
                    (_k = message === null || message === void 0 ? void 0 : message.media) !==
                        null && _k !== void 0
                        ? _k
                        : false
            }
    ...
    if ('shop' in message && !!message.shop) {
        const interactiveMessage = {
            shopStorefrontMessage:
                Types_1.WAProto.Message.InteractiveMessage.ShopMessage.fromObject({
        ...
        if ('text' in message) {
            ...
            interactiveMessage.header = {
                ...
                subtitle: message.subtitle,
                hasMediaAttachment:
                    (_l = message === null || message === void 0 ? void 0 : message.media) !==
                        null && _l !== void 0
                        ? _l
                        : false
            }
        ...
        if ('title' in message && !!message.title) {
            interactiveMessage.header = {
                ...
                subtitle: message.subtitle,
                hasMediaAttachment:
                    (_m = message === null || message === void 0 ? void 0 : message.media) !==
                        null && _m !== void 0
                        ? _m
                        : false
            }
    ...
    if (
        'mentions' in message &&
        ((_o = message.mentions) === null || _o === void 0 ? void 0 : _o.length)
    ) {
    ...
    const messageJSON = {
        key: {
            ...
            id:
                ...
                (0, generics_1.generateMessageIDV2)()
        },
        message: message,
