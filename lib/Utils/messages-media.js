...
const extractImageThumb = async (bufferOrFilePath, width = 32) => {
    ...
    if (
        'sharp' in lib &&
        typeof ((_a = lib.sharp) === null || _a === void 0 ? void 0 : _a.default) === 'function'
    ) {
        ...
        'jimp' in lib &&
        typeof ((_b = lib.jimp) === null || _b === void 0 ? void 0 : _b.read) === 'function'
    ) {
...
const mediaMessageSHA256B64 = (message) => {
    ...
    return (
        (media === null || media === void 0 ? void 0 : media.fileSha256) &&
...
async function getAudioDuration(buffer) {
    try {
        ...
        return await new Promise((resolve, reject) => {
            ...
            ff(inputStream).ffprobe((err, data) => {
                if (err) reject(err)
...
async function generateThumbnail(file, mediaType, options) {
    ...
    if (mediaType === 'image') {
        ...
        const imgFilename = (0, path_1.join)(
            getTmpFilesDirectory(),
            (0, generics_1.generateMessageID)() + '.jpg'
        )
        try {
            ...
            ;(_a = options.logger) === null || _a === void 0
                ? void 0
                : _a.debug('could not generate video thumb: ' + err)
        }
    }
    return {
        thumbnail,
    ...
    try {
        ...
        if (type === 'file') {
            ...
            bodyPath = (0, path_1.join)(
                getTmpFilesDirectory(),
                mediaType + (0, generics_1.generateMessageID)()
            )
...
const encryptedStream = async (
    media,
    mediaType,
    { logger, saveOriginalFileIfRequired, opts, isPtt, forceOpus } = {}
) => {
    const { stream, type } = await (0, exports.getStream)(media, opts)
    ...
    return async (stream, { mediaType, fileEncSha256B64, newsletter, timeoutMs }) => {
        ...
        if (newsletter) {
            media =
                media === null || media === void 0
                    ? void 0
                    : media.replace('/mms/', '/newsletter/newsletter-')
        }
        for (const { hostname, maxContentLengthBytes } of hosts) {
            ...
            try {
                ...
                result = body.data
                if (
                    (result === null || result === void 0 ? void 0 : result.url) ||
                    (result === null || result === void 0 ? void 0 : result.directPath)
                ) {
                    urls = {
                        mediaUrl: result.url,
                ...
                const isLast =
                    hostname ===
                    ((_b = hosts[uploadInfo.hosts.length - 1]) === null || _b === void 0
                        ? void 0
                        : _b.hostname)
                logger.warn(
