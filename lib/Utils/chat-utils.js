    ...
    const { hash, indexValueMap } = await (0, exports.decodeSyncdMutations)(
        ...
        areMutationsRequired
            ? (mutation) => {
                  var _a
                  const index =
                      (_a = mutation.syncAction.index) === null || _a === void 0
                          ? void 0
                          : _a.toString()
        ...
        if (Array.isArray(lastMessages)) {
            ...
            messageRange = {
                lastMessageTimestamp:
                    lastMsg === null || lastMsg === void 0 ? void 0 : lastMsg.messageTimestamp,
                messages: (
                    lastMessages === null || lastMessages === void 0 ? void 0 : lastMessages.length
                )
                    ? lastMessages.map((m) => {
                          var _a, _b
                          if (
                          ...
                          if (
                              !m.messageTimestamp ||
                              !(0, generics_1.toNumber)(m.messageTimestamp)
                          ) {
...
const processSyncAction = (syncAction, ev, me, initialSyncOpts, logger) => {
    ...
    const accountSettings =
        initialSyncOpts === null || initialSyncOpts === void 0
            ? void 0
            : initialSyncOpts.accountSettings
    logger === null || logger === void 0
        ? void 0
    ...
    if (action === null || action === void 0 ? void 0 : action.muteAction) {
        ev.emit('chats.update', [
            {
                id,
                muteEndTime: (
                    (_a = action.muteAction) === null || _a === void 0 ? void 0 : _a.muted
                )
        ...
        // 	isArchived = false
        // }
        const msgRange = !(accountSettings === null || accountSettings === void 0
            ? void 0
        ...
        ev.emit('chats.update', [
            {
                ...
                unreadCount: isNullUpdate
                    ? null
                    : !!(markReadAction === null || markReadAction === void 0
                            ? void 0
                            : markReadAction.read)
                      ? 0
                      : -1,
        ...
        const name =
            (_b = action === null || action === void 0 ? void 0 : action.pushNameSetting) ===
                null || _b === void 0
                ? void 0
                : _b.name
        ...
        ev.emit('chats.update', [
            {
                ...
                pinned: ((_c = action.pinAction) === null || _c === void 0 ? void 0 : _c.pinned)
                    ? (0, generics_1.toNumber)(action.timestamp)
                    : null,
                conditional: getChatUpdateConditional(id, undefined)
            }
        ])
        ...
        (action === null || action === void 0 ? void 0 : action.starAction) ||
        type === 'star'
    ) {
        let starred =
            (_d = action === null || action === void 0 ? void 0 : action.starAction) === null ||
            _d === void 0
                ? void 0
                : _d.starred
        ...
        (action === null || action === void 0 ? void 0 : action.deleteChatAction) ||
        type === 'deleteChat'
    ) {
        if (!isInitialSync) {
