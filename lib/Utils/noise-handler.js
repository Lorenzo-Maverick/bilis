...
const makeNoiseHandler = ({
    ...
    const encrypt = (plaintext) => {
        const result = (0, crypto_1.aesEncryptGCM)(
            plaintext,
            encKey,
    ...
    return {
        ...
        processHandshake: ({ serverHello }, noiseKey) => {
            ...
            if (mobile) {
                ...
                const { issuerSerial } = WAProto_1.proto.CertChain.NoiseCertificate.Details.decode(
        ...
        decodeFrame: (newData, onFrame) => {
            ...
            while (size && inBytes.length >= size + 3) {
                ...
                logger.trace(
                    {
                        msg:
                            (_a = frame === null || frame === void 0 ? void 0 : frame.attrs) ===
                                null || _a === void 0
                                ? void 0
                                : _a.id
                    },
