            ...
            for (const chat of item.conversations) {
                ...
                for (const item of msgs) {
                    ...
                    if (!message.key.fromMe && !chat.lastMessageRecvTimestamp) {
                        chat.lastMessageRecvTimestamp = (0, generics_1.toNumber)(
                    ...
                    if (
                        ...
                        ((_b = message.messageStubParameters) === null || _b === void 0
                            ? void 0
                            : _b[0])
                    ) {
                        contacts.push({
                            ...
                            verifiedName:
                                (_c = message.messageStubParameters) === null || _c === void 0
                                    ? void 0
                                    : _c[0]
                        })
                    }
    ...
    const anyHistoryMsg =
        (_a =
            normalizedContent === null || normalizedContent === void 0
                ? void 0
                : normalizedContent.protocolMessage) === null || _a === void 0
            ? void 0
            : _a.historySyncNotification
