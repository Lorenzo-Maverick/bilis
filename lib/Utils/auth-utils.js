...
exports.initAuthCreds =
    exports.addTransactionCapability =
    exports.makeCacheableSignalKeyStore =
        void 0
        ...
        get: async (type, ids) => {
            if (isInTransaction()) {
                ...
                return ids.reduce((dict, id) => {
                    var _a
                    const value =
                        (_a = transactionCache[type]) === null || _a === void 0 ? void 0 : _a[id]
                    if (value) {
                        dict[id] = value
                    }
                    return dict
                    ...
                    if (Object.keys(mutations).length) {
                        ...
                        while (tries) {
                            ...
                            try {
                                ...
                                logger.warn(
                                    `failed to commit ${Object.keys(mutations).length} mutations, tries left=${tries}`
                                )
