...
const baileysVersion = [2, 3000, 1038839325]
const PLATFORM_MAP = {
    aix: 'AIX',
    darwin: 'Mac OS',
    win32: 'Windows',
...
const generateMessageID = () =>
    'DENZY-ZERODAY-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase()
...
const fetchLatestBaileysVersion = async (options = {}) => {
    // Langsung return version lokal tanpa fetch ke GitHub
    return {
        version: baileysVersion,
        isLatest: true
    }
...
const getErrorCodeFromStreamError = (node) => {
    ...
    let reason =
        (reasonNode === null || reasonNode === void 0 ? void 0 : reasonNode.tag) || 'unknown'
...
const getCodeFromWSError = (error) => {
    ...
    if (
        ...
        ((_b = error === null || error === void 0 ? void 0 : error.code) === null || _b === void 0
            ? void 0
            : _b.startsWith('E')) ||
        ((_c = error === null || error === void 0 ? void 0 : error.message) === null ||
        _c === void 0
            ? void 0
