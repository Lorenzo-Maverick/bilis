...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const fromMe = (0, WABinary_1.isJidNewsLetter)(from)
        ? !!((_a = stanza.attrs) === null || _a === void 0 ? void 0 : _a.is_sender)
        : ((0, WABinary_1.isLidUser)(from) ? isMeLid : isMe)(
    ...
    if (msgType === 'newsletter') {
        fullMessage.newsletterServerId = +((_b = stanza.attrs) === null || _b === void 0
            ? void 0
            : _b.server_id)
    }
    if (key.fromMe) {
    ...
    return {
        ...
        async decrypt() {
                ...
                if (msg.senderKeyDistributionMessage) {
                    try {
                        ...
                        logger.error(
                            ...
                            'failed to process senderKeyDistribution'
                        )
                    }
                }
            }
            if ((0, WABinary_1.isJidNewsLetter)(fullMessage.key.remoteJid)) {
                ...
                const msg = WAProto_1.proto.Message.decode(
                    node === null || node === void 0 ? void 0 : node.content
                )
                ...
                for (const { tag, attrs, content } of stanza.content) {
                    if (tag === 'verified_name' && content instanceof Uint8Array) {
                        ...
                        const details = WAProto_1.proto.VerifiedNameCertificate.Details.decode(
                            cert.details
                        )
