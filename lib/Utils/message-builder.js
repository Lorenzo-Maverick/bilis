...
const button = Button, buttonV2 = ButtonV2, carousel = Carousel, aiRich = AIRich;
module.exports = { VERSION, Button, ButtonV2, Carousel, AIRich, Toolkit, bind, button, buttonV2, carousel, aiRich };
