...
exports.createMessageSearch =
    exports.MessageSearchManager =
    exports.searchMessagesRegex =
    exports.searchMessages =
    exports.extractMessageText =
        void 0
...
class MessageSearchManager {
    ...
    getBySender(sender) {
        return this.messages.filter(
            (m) => m.key.participant === sender || m.key.remoteJid === sender
        )
    }
