...
const areJidsSameUser = (jid1, jid2) => {
    var _a, _b
    return (
        ((_a = (0, exports.jidDecode)(jid1)) === null || _a === void 0 ? void 0 : _a.user) ===
        ((_b = (0, exports.jidDecode)(jid2)) === null || _b === void 0 ? void 0 : _b.user)
    )
}
exports.areJidsSameUser = areJidsSameUser
/** is the jid a user */
const isJidUser = (jid) =>
    jid === null || jid === void 0 ? void 0 : jid.endsWith('@s.whatsapp.net')
...
const isJidBroadcast = (jid) =>
    jid === null || jid === void 0 ? void 0 : jid.endsWith('@broadcast')
